...
try:
    __version__ = version("pydantic-httpx")
...
__all__ = [
    ...
    "SSEEventClass",
    "RawSSEEventClass",
    "SSEPydanticEventClass",
    "JSONSSEEventClass",
    "PlainTextSSEEventClass",
]
